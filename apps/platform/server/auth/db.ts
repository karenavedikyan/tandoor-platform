...
export type AuthDrizzle = ReturnType<typeof drizzle<typeof mergedSchema>>;
...
export function getAuthDb(): AuthDrizzle | null {
  ...
  cached = drizzle(client as ReturnType<typeof neon>, { schema: mergedSchema }) as AuthDrizzle;
  return cached;
}
