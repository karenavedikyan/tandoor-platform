...
import type { BrandBriefThemeMode } from "@/components/marketing-brief/brand-brief-theme";
import {
  fetchPublicBrief,
...
export default function MarketingBriefPublicPage() {
  ...
  return (
    <div className="brief-public-shell min-h-screen bg-background" data-testid="page-marketing-brief-public">
      <BrandBriefView
        brief={brief}
        blocks={blocks}
        showShare
