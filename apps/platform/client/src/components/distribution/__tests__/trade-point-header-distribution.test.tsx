...
describe("trade point header distribution block", () => {
  it("renders mini-bar for a single trade point external key", () => {
    ...
    expect(getByTestId("trade-point-header-distribution-wrap")).toBeTruthy();
    expect(getByTestId("trade-point-header-distribution")).toBeTruthy();
