...
export const WIKI_TRAINING_IMPORT_SEED: WikiTrainingImportSeedItem[] = [
  {
    ...
    summary:
      "Свод по межкомнатным дверям: серии, типовые размеры и логика чтения таблицы для консультации в салоне. Полная версия хранится во внутренней базе.",
    contentBlocks: [
      {
  ...
  },
  {
    ...
    reviewStatus: "needs_review",
    summary:
      "Сравнительная выборка по входным группам: позиционирование без раскрытия закрытых цен и поставщиков.",
    contentBlocks: [
      {
        heading: "Сценарий сравнения",
        body: "Используйте блоки «конструкция», «фурнитура», «срок» как опорные точки разговора. Детальные строки таблицы доступны после ревью материала.",
      },
    ],
    ...
    contentBlocks: [
      {
        ...
        body: "Кратко зафиксированы типовые статусы и переходы к заказу без внутренних кодов позиций.",
      },
    ],
    ...
    contentBlocks: [
      {
        ...
        body: "Согласование класса замка с полотном и требованиями объекта. Расширенные спецификации подключаются из закрытого хранилища после ревью.",
      },
    ],
  ...
  },
  {
    ...
    reviewStatus: "approved",
    summary: "Порядок демонстрации МК в шоуруме: открытие, фокус на покрытии, закрытие на следующий шаг.",
    contentBlocks: [
      {
        heading: "Структура визита",
        body: "Нейтральный сценарий без записей внутренних тренингов и персональных данных.",
      },
    ],
    ...
    contentBlocks: [
      {
        ...
        body: "Коротко о слоях и сертификации без ссылок на закрытые лабораторные отчёты.",
      },
    ],
  ...
  },
  {
    ...
    contentBlocks: [
      {
        heading: "Сводка",
        body: "Сжатое описание для консультанта; полные техлисты остаются во внутреннем контуре.",
      },
    ],
    ...
    contentBlocks: [
      {
        ...
        body: "Акцент на назначении и сочетаемости с интерьером; подробные чертежи — после подключения закрытого хранилища.",
      },
    ],
  ...
  },
  {
    ...
    reviewStatus: "approved",
    summary: "Краткое описание подходов АНП и СПИН для оптового диалога без внутренних скриптов закрытой Wiki.",
    contentBlocks: [
      {
        heading: "Применение",
        body: "Используйте как каркас вопросов; полные методички доступны после ревью и выдачи доступа.",
      },
    ],
  ...
  },
  {
    ...
    reviewStatus: "needs_review",
    summary: "Семь правил в сжатой формулировке; развёрнутые кейсы переносятся из Wiki после проверки.",
    contentBlocks: [
      {
        heading: "Правила",
  ...
  },
  {
    ...
    reviewStatus: "approved",
    summary: "Обзор разделов Битрикс24, используемых отделом: задачи, чат, диск — без ссылок на закрытый портал.",
    contentBlocks: [
      {
  ...
  },
  {
    ...
    reviewStatus: "needs_review",
    summary: "Чек-лист знаний по неделям адаптации; детальные матрицы компетенций — во внутреннем контуре.",
    contentBlocks: [
      {
        heading: "Недели 1–4",
    ...
    contentBlocks: [
      {
        ...
        body: "Список полей и действий без внутренних номеров заявок и сканов.",
      },
    ],
