...
const QUICK_LINKS: GlobalSearchQuickLink[] = [
  ...
  { id: "one-c-showroom", label: "1С витрина", href: "/1c", keywords: "1с витрина exchange" },
  { id: "one-c-stores", label: "Торговые точки 1С", href: "/1c/stores", keywords: "1с тт точки stores" },
  { id: "one-c-legals", label: "Клиенты 1С", href: "/1c/legals", keywords: "1с клиенты legals" },
